...
const terminalElem = document.getElementById('term-logs');
...
ptyProc.write(`KUBECONFIG=${appPath}/k8s/config KUBECTL_BIN="${appPath}/k8s/${kubectl} --token __token__" ${appPath}/k8s/kubetail --namespace __namespace__ -l app=__app_name__ -k pod\n`)
